...
- [ ] T053 [P] [US5] Write scope, expiry, revocation and redaction tests in apps/backend/tests/security/
- [ ] T054 [US5] Implement Infisical machine-identity adapter in apps/backend/src/kya_platform/infrastructure/infisical/
- [ ] T055 [US5] Implement secret-use request and approval service in apps/backend/src/kya_platform/application/secrets/
